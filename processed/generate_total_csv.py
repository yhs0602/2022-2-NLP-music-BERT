...
argparser.add_argument(
    "augmented-dir", type=str, help="directory of augmented midi files with a trailing slash"
)
...
if __name__ == "__main__":
    ...
    for filename in os.listdir(args.augmented_dir):
        ...
        original_row = table[original_filename]
        # create a new row
    ...
    with zipfile.ZipFile('augmented_segmented_midi.zip', 'x') as myzip:
